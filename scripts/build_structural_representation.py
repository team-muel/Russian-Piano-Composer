...
def main() -> None:
    ...
    print(f"  RC-011 Implementation Commit SHA:       {lineage.rc011_implementation_commit_sha}")
    ...
    print(f"  Tonal Parameter Policy Hash:            {lineage.tonal_policy_hash}")
    print(f"  Sonority Parameter Policy Hash:         {lineage.sonority_policy_hash}")
    print(f"  Cadence Parameter Policy Hash:          {lineage.cadence_policy_hash}")
    print(f"  Form Parameter Policy Hash:             {lineage.form_policy_hash}")
    print(f"  Voice-Leading Parameter Policy Hash:    {lineage.vl_policy_hash}")
    print(f"  Texture Parameter Policy Hash:          {lineage.texture_policy_hash}")
    print(f"  Trajectory Parameter Policy Hash:       {lineage.trajectory_policy_hash}")
    print(f"  Tonal Algorithm Semantic Hash:          {lineage.tonal_semantic_hash}")
    print(f"  Sonority Algorithm Semantic Hash:       {lineage.sonority_semantic_hash}")
    print(f"  Cadence Algorithm Semantic Hash:        {lineage.cadence_semantic_hash}")
    print(f"  Form Algorithm Semantic Hash:           {lineage.form_semantic_hash}")
    print(f"  Voice-Leading Algorithm Semantic Hash:  {lineage.vl_semantic_hash}")
    print(f"  Texture Algorithm Semantic Hash:        {lineage.texture_semantic_hash}")
    print(f"  Trajectory Algorithm Semantic Hash:     {lineage.trajectory_semantic_hash}")
    ...
    print(f"  Metamorphic Test Matrix Hash:           {lineage.metamorphic_test_matrix_hash}")
    print(f"  Structure Analysis Source Hash:         {lineage.structure_analysis_source_hash}")
