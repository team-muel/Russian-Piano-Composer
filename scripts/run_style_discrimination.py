...
def main() -> None:
    ...
    # 1. Role-blind feature matrix construction
    ...
    # 2. Outer 9-fold evaluation across models
    ...
    # 3. Model Ablation & Performance Comparison
    ...
    # 4. Exact 20-Composer-Level Permutation Test
    ...
    print(f"Observed Rank:                   {perm_res.observed_rank} / {perm_res.total_assignments}")
    ...
    # 5. Feature-Level Interpretation & Statistics
    ...
    # 7. Scientific Limitations Statement
    ...
    print("4. Exact permutation inference has only 20 possible composer-label assignments (min p = 0.05).")
